...
from dataset import FolderBasedDataset, create_data_loader
...
def create_dataloaders(train_dir, val_dir, resize, batch_size):
    ...
    train_dataloader, val_dataloader = create_data_loader(train_dataset, val_dataset, batch_size)
